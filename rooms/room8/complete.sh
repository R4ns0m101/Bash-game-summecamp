...
EXPECTED_ROOM=8
EXPECTED_HASH="b934fdef3a941f1b8fd3fd6c96f249f4ac755a8a274ce70ca0d177beafd2b382"

# 🚪 Level Lock — must be at the correct room
CURRENT=$(cat ../../.progress 2>/dev/null)
if [ "$CURRENT" != "$EXPECTED_ROOM" ]; then
    echo "🔒 Room 8 is locked! You are on room $CURRENT."
    exit 1
fi
